          ...
          <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-lg border dark:bg-gray-800 sm:mt-40">
            ...
            <form>
              ...
              <div className="flex justify-end mt-6">
                <button
                  className="issue-btn px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-yellow-400 rounded-md hover:bg-yellow-500 focus:outline-none focus:bg-gray-600 w-60"
